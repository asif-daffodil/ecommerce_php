			...
			<div class="blog-page">
				...
				<?php
					...
					<div class="blog-post  wow fadeInUp">
						<a href="#"><img class="img-responsive" src="assets/images/blog-post/blog_big_01.jpg" alt=""></a>
						<h1><a href="#"><?= $data['title'];?></a></h1>
						<span class="author"><?= $data['writer_name'];?></span>
						<span class="review">6 Comments</span>
						<span class="date-time"><?=date('F js, Y', strtotime($data['create_at'])) ;?></span>
						
						<p><?= substr($data['description'], 0, 40);?></p>
