  ...
  <div class="container">
    <div class="row"> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            ...
            <ul class="nav">
              ...
              ?>
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="<?= $data['icon'];?>" aria-hidden="true"></i><?=  $data['name']; ?></a>
              
              <?php  
                $proSubCat = $db->proSubCategory($data['id']);
                if(count($proSubCat) > 0):
              ?>
                <ul class="dropdown-menu mega-menu">
                <?php  
                  foreach($proSubCat as $subData):
                ?>
                  <li class="yamm-content">
                    <div class="row">
                    <?php  
                        $proSubSubCat = $db->proSubSubCategory($subData['id']);
                        if(count($proSubSubCat) > 0):
                    ?>
                    <?php  foreach($proSubSubCat as $subsubData): ?>
                      <div class="col-sm-12 col-md-3">
                        <ul class="links list-unstyled">
                            <li><a href="#"><?=$subsubData['name']?></a></li> 
                        </ul>
                      </div>
                      <?php  endforeach; ?>
                      <?php  endif; ?>
      ...
      <?php  include_once('slider.php') ?>
       ...
       <?php  include_once('./sliderBottom.php') ?>
       <?php  include_once('./newProducts.php') ?> 
        <!-- ============================================== SCROLL TABS : END ============================================== --> 
        <!-- ============================================== WIDE PRODUCTS ============================================== -->
          ...
          <div class="row">
            <div class="col-md-7 col-sm-7">
              <div class="wide-banner cnt-strip">
                <div class="" style="height: 180px;"> <img style="height: 180px; width:100%; object-fit:cover;" class="" src="assets/images/banners/home-banner1.jpg" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            <!-- /.col -->
            <div class="col-md-5 col-sm-5">
              <div class="wide-banner cnt-strip">
                <div class="" style="height: 180px;"> <img style="height: 180px; width:100%; object-fit:cover;" class="" src="assets/images/banners/home-banner2.jpg" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            <!-- /.col --> 
        ...
        <!-- ============================================== WIDE PRODUCTS : END ============================================== --> 
        <?php  include_once('./featuredProduct.php') ?>
        <!-- ============================================== WIDE PRODUCTS ============================================== -->
        <div class="wide-banners wow fadeInUp outer-bottom-xs">
          <div class="row">
            <div class="col-md-12">
              <div class="wide-banner cnt-strip">
                <div class="image"> 
                  <img class="" style="width: 100%; position:relative; z-index: 1;" src="assets/images/banners/home-banner.png" alt="">
                  <div class="color-transprant" style="position: absolute; top:0; left:0; width:100%; height:100%; background:rgba(5, 5, 5, .3); z-index: 2; "></div> 
                </div>
                <div class="strip strip-text" style="z-index: 3;">
              ...
              <div class="item">
                <div class="blog-post">
                  <div class="blog-post-image">
                    <div class="image"> <a href="blog.php"><img src="assets/images/blog-post/<?= $data['blog_image'];?>" alt=""></a> </div>
                  </div>
                  <!-- /.blog-post-image -->
                  
                  <div class="blog-post-info text-left">
                    <h3 class="name"><a href="#"><?= $data['title'];?></a></h3>
                    <span class="info"><?= $data['writer_name'];?> &nbsp;|&nbsp; <?=date('F js, Y', strtotime($data['create_at'])) ;?>  </span>
                    <p class="text"><?= substr($data['description'], 0, 100);?></p>
             
                    <a href="blog.php?=<?= $data['id'];?>" class="lnk btn btn-primary">Read more</a> </div>
